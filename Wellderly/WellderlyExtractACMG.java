...
public class WellderlyExtractACMG {
    ...
    public static void readFile(String inputFile) throws FileNotFoundException, IOException{
            outfile = new BufferedWriter(new FileWriter("ACMGvariants_Bipolar.txt", true));    
    ...
    public static void main(String[] args) throws IOException {
           System.out.println("Usage javac WellderlyExtractACMG.java full/path/to/file /path/to/existing/counter");
