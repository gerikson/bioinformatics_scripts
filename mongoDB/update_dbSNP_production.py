...
while line:
    ...
    if (count_var%10000 == 0):
    	print "Total number of variants parsed: " + str(count_var)
        print time.asctime( time.localtime(time.time()) )	  	
	...
	'''
        ...
        if (skiped_var%10000 == 0):
           print "New variants inserted: " + str(skiped_var)
           print time.asctime( time.localtime(time.time()) )
	...
	annot = ""  
		...
		if (inserted_variants%10000 == 0):
            		print "Variants edited: " + str(inserted_variants)
            		print time.asctime( time.localtime(time.time()) )
...
print "Not found var = " + str(skiped_var)
