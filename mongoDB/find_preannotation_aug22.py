...
while line != "":
	...
	com = line[7]
    	...
    	#variant_list = PreAnnotationDB.find_one({'chrom':CUR_CHROM,'beg':beg, 'end':end,'type':vartype ,'ref':ref,'alt':obs})
        #variant_list = PreAnnotationDB.find_one({'chrom':CUR_CHROM,'beg':beg, 'end':end, 'ref':ref, 'alt':obs})
	...
	"""
	    ...
	    counter_notFound = counter_notFound + 1	
            outres.write(str(counter_notFound) + "\t" + str(chrom) + "\t" +str(beg) + "\t" + str(end) + "\t" + str(vartype) + "\t" + str(ref) + "\t" + str(obs)+ "\t" + str(com) + "\n")
            #outres.write("\n")
            #var_it += 1
            #FOUND = False
            line = invar.readline()
	    ...
	    counter_found = counter_found + 1	
            outres_dbsnp.write(str(counter_found) + "\t" + str(chrom) + "\t" +str(beg) + "\t" + str(end) + "\t" + str(vartype) + "\t" + str(ref) + "\t" + str(obs)+ "\t" + str(com) + "\t")    
